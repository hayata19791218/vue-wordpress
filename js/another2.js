...
jQuery(function(){
  jQuery('.change1').hover(function(){
    jQuery('.change1').text('トップ').removeClass('u-another-font4');
  },function(){
    jQuery('.change1').text('Top').addClass('u-another-font4');
  });
  jQuery('.change2').hover(function(){
    jQuery('.change2').text('目的検索').removeClass('u-another-font4');
  },function(){
    jQuery('.change2').text('Search').addClass('u-another-font4');
  });
  jQuery('.change3').hover(function(){
    jQuery('.change3').text('機能一覧').removeClass('u-another-font4');
  },function(){
    jQuery('.change3').text('Function').addClass('u-another-font4');
  });
  jQuery('.change4').hover(function(){
    jQuery('.change4').text('事例紹介').removeClass('u-another-font4');
  },function(){
    jQuery('.change4').text('Case').addClass('u-another-font4');
  });
  jQuery('.change5').hover(function(){
    jQuery('.change5').text('セキュリティ').removeClass('u-another-font4');
  },function(){
    jQuery('.change5').text('Security').addClass('u-another-font4');
  });
  jQuery('.change6').hover(function(){
    jQuery('.change6').text('デモ体験').removeClass('u-another-font4');
  },function(){
    jQuery('.change6').text('Trial').addClass('u-another-font4');
  });
  jQuery('.change7').hover(function(){
    jQuery('.change7').text('料金').removeClass('u-another-font4');
  },function(){
    jQuery('.change7').text('Price').addClass('u-another-font4');
  });
  jQuery('.change8').hover(function(){
    jQuery('.change8').text('オプション');
  },function(){
    jQuery('.change8').text('Option▼');
    jQuery('.u-another-font4').addClass('u-another-font4');
  });
})